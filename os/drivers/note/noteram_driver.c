...
// #include <tinyara/panic_notifier.h> //Porting from NuttX
...
#  endif
  ...
  .ni_buffer = g_ramnote_buffer,
  .ni_bufsize = CONFIG_DRIVERS_NOTERAM_BUFSIZE,
  .ni_overwrite =
...
#endif
  NOTE_FILTER_IRQMASK_SET(27, &g_noteram_driver.driver.filter.irq_mask);
  NOTE_FILTER_IRQMASK_SET(40, &g_noteram_driver.driver.filter.irq_mask);
