...
#include <tinyara/instrument.h>
#include <tinyara/note/note_driver.h>
#include <tinyara/note/noteram_driver.h>
#include <tinyara/note/notectl_driver.h>
#include <tinyara/note/notesnap_driver.h>
#include <tinyara/note/notestream_driver.h>
// #include <tinyara/segger/note_rtt.h>
// #include <tinyara/segger/sysview.h>
...
int note_early_initialize(void)
{
  ...
  if (ret < 0)
    {
      lldbg("note_sysview_initialize failed %d\n", ret);
      return ret;
    }
#endif
  ...
  if (ret < 0)
    {
      lldbg("notesnap_register failed %d\n", ret);
      return ret;
    }
#endif
...
int note_initialize(void)
{
  ...
  if (ret < 0)
    {
      lldbg("noteram_register failed %d\n", ret);
      return ret;
    }
#endif
  ...
  if (ret < 0)
    {
      lldbg("notefile_register failed %d\n", ret);
      return ret;
    }
#endif
  ...
  if (ret < 0)
    {
      lldbg("notertt_register failed %d\n", ret);
      return ret;
    }
#endif
  ...
  if (ret < 0)
    {
      lldbg("notectl_register failed %d\n", ret);
      return ret;
    }
#endif
  ...
  if (ret < 0)
    {
      lldbg("noterpmsg_server_init failed %d\n", ret);
      return ret;
    }
#endif
