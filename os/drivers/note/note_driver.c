...
#include <tinyara/note/notelog_driver.h>
#include <tinyara/note/notestream_driver.h>
#include <tinyara/spinlock.h>
#include <tinyara/sched_note.h>
#include <tinyara/arch.h> //Porting from NuttX
                        ...
                        uint8_t length, uint8_t type)
{
  ...
  if (tcb == NULL)
    {
      note->nc_priority = SCHED_PRIORITY_DEFAULT; //Porting from NuttX
      note->nc_pid = 0;
    }
  else
    {
  ...
  note->nc_systime = perf_gettime(); //Porting from NuttX
}
